...
We mostly maintain the codebase for the streamlit entrpoints which allow interacting with YoutubeBuddy via chat. We use Assistants API(using GPT 4.1 nana)from OpenAI for the chatbot and use the 'gpt-5-nano' model for all processing.
